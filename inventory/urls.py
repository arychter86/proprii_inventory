...
urlpatterns = [
     ...
     url(r'^inventory/(?P<id>[0-9]+)/map/(?P<id_map>[0-9]+)/$', login_required(InventoryMapView.as_view())),
     url(r'^inventory/(?P<id>[0-9]+)/map/(?P<id_map>[0-9]+)/delete/$', login_required(InventoryMapView.as_view())),
     url(r'^inventory/(?P<id>[0-9]+)/map/(?P<id_map>[0-9]+)/treeonmap/(?P<id_tree>[0-9]+)/$', login_required(TreeOnMapView.as_view())),
